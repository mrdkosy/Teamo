...
(function() {
	...
	this.Game = (function() {
		var YOUTUBE_ID, _endTime, _game, _isNoteGenerateTiming, _judge, _proccesRootSceneFrame, _status, _timing, _timingIndex, _yt;
		...
		var laneNumber = new Array(_timing.length);
